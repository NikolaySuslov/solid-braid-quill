...
export default async function simpleton_client(url, peerID, { apply_remote_update, generate_local_diff_update, content_type, on_error }) {
    var peer = peerID ? peerID : Math.random().toString(36).substr(2)
    var current_version = []
    var prev_state = ""
    var char_counter = -1
